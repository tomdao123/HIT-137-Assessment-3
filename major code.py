...
# loading images 
#button
start_image = pygame.image.load(file_path + 'img/start_btn.png').convert_alpha()
restart_image = pygame.image.load(file_path + 'img/restart_btn.png').convert_alpha()
exit_image = pygame.image.load(file_path + 'img/exit_btn.png').convert_alpha()
#background
sky_image = pygame.image.load(file_path + 'img/Background/sky_cloud.png').convert_alpha()
mountain_image = pygame.image.load(file_path + 'img/Background/mountain.png').convert_alpha()
pine1_image = pygame.image.load(file_path + 'img/Background/pine1.png').convert_alpha()
pine2_image = pygame.image.load(file_path + 'img/Background/pine2.png').convert_alpha()
...
#bullet
bullet_image = pygame.image.load(file_path + 'img/icons/bullet.png').convert_alpha()
#grenade
grenade_image = pygame.image.load(file_path + 'img/icons/grenade.png').convert_alpha()
#pickup boxes 
health_box_image = pygame.image.load(file_path + 'img/icons/health_box.png').convert_alpha()
ammo_box_image = pygame.image.load(file_path + 'img/icons/ammo_box.png').convert_alpha()
grenade_box_image = pygame.image.load(file_path + 'img/icons/grenade_box.png').convert_alpha()
item_boxes = {
